                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_1" type="radio" name="question_1" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_2" type="radio" name="question_2" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_2" type="radio" name="question_2" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_2" type="radio" name="question_2" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_2" type="radio" name="question_2" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_2" type="radio" name="question_2" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_3" type="radio" name="question_3" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_3" type="radio" name="question_3" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_3" type="radio" name="question_3" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_3" type="radio" name="question_3" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_3" type="radio" name="question_3" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_4" type="radio" name="question_4" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_5" type="radio" name="question_5" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_5" type="radio" name="question_5" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_5" type="radio" name="question_5" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_5" type="radio" name="question_5" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_5" type="radio" name="question_5" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_6" type="radio" name="question_6" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_6" type="radio" name="question_6" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_6" type="radio" name="question_6" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_6" type="radio" name="question_6" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_6" type="radio" name="question_6" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_7" type="radio" name="question_7" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_7" type="radio" name="question_7" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_7" type="radio" name="question_7" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_7" type="radio" name="question_7" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_7" type="radio" name="question_7" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_8" type="radio" name="question_8" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_8" type="radio" name="question_8" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_8" type="radio" name="question_8" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_8" type="radio" name="question_8" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_8" type="radio" name="question_8" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_9" type="radio" name="question_9" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_9" type="radio" name="question_9" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_9" type="radio" name="question_9" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_9" type="radio" name="question_9" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_9" type="radio" name="question_9" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_10" type="radio" name="question_10" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_10" type="radio" name="question_10" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_10" type="radio" name="question_10" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_10" type="radio" name="question_10" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_10" type="radio" name="question_10" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_11" type="radio" name="question_11" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_11" type="radio" name="question_11" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_11" type="radio" name="question_11" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_11" type="radio" name="question_11" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_11" type="radio" name="question_11" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_12" type="radio" name="question_12" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_12" type="radio" name="question_12" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_12" type="radio" name="question_12" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_12" type="radio" name="question_12" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_12" type="radio" name="question_12" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_13" type="radio" name="question_13" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_13" type="radio" name="question_13" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_13" type="radio" name="question_13" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_13" type="radio" name="question_13" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_13" type="radio" name="question_13" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_14" type="radio" name="question_14" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_14" type="radio" name="question_14" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_14" type="radio" name="question_14" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_14" type="radio" name="question_14" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_14" type="radio" name="question_14" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_15" type="radio" name="question_15" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_15" type="radio" name="question_15" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_15" type="radio" name="question_15" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_15" type="radio" name="question_15" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_15" type="radio" name="question_15" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_16" type="radio" name="question_16" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_16" type="radio" name="question_16" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_16" type="radio" name="question_16" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_16" type="radio" name="question_16" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_16" type="radio" name="question_16" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_17" type="radio" name="question_17" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_17" type="radio" name="question_17" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_17" type="radio" name="question_17" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_17" type="radio" name="question_17" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_17" type="radio" name="question_17" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_18" type="radio" name="question_18" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_18" type="radio" name="question_18" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_18" type="radio" name="question_18" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_18" type="radio" name="question_18" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_18" type="radio" name="question_18" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_19" type="radio" name="question_19" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_19" type="radio" name="question_19" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_19" type="radio" name="question_19" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_19" type="radio" name="question_19" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_19" type="radio" name="question_19" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_20" type="radio" name="question_20" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_20" type="radio" name="question_20" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_20" type="radio" name="question_20" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_20" type="radio" name="question_20" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_20" type="radio" name="question_20" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_21" type="radio" name="question_21" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_21" type="radio" name="question_21" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_21" type="radio" name="question_21" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_21" type="radio" name="question_21" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_21" type="radio" name="question_21" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_22" type="radio" name="question_22" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_22" type="radio" name="question_22" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_22" type="radio" name="question_22" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_22" type="radio" name="question_22" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_22" type="radio" name="question_22" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_23" type="radio" name="question_23" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_24" type="radio" name="question_24" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_25" type="radio" name="question_25" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_26" type="radio" name="question_26" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_27" type="radio" name="question_27" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_28" type="radio" name="question_28" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_29" type="radio" name="question_29" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_30" type="radio" name="question_30" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_31" type="radio" name="question_31" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_32" type="radio" name="question_32" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_33" type="radio" name="question_33" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_34" type="radio" name="question_34" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_35" type="radio" name="question_35" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_36" type="radio" name="question_36" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_37" type="radio" name="question_37" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_38" type="radio" name="question_38" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_39" type="radio" name="question_39" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_47" type="radio" name="question_47" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_48" type="radio" name="question_48" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_49" type="radio" name="question_49" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_50" type="radio" name="question_50" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_51" type="radio" name="question_51" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_52" type="radio" name="question_52" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_53" type="radio" name="question_53" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_54" type="radio" name="question_54" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_55" type="radio" name="question_55" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_56" type="radio" name="question_56" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_57" type="radio" name="question_57" value="1">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_58" type="radio" name="question_58" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_58" type="radio" name="question_58" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_58" type="radio" name="question_58" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_58" type="radio" name="question_58" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_58" type="radio" name="question_58" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_59" type="radio" name="question_59" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_59" type="radio" name="question_59" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_59" type="radio" name="question_59" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_59" type="radio" name="question_59" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_59" type="radio" name="question_59" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_60" type="radio" name="question_60" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_60" type="radio" name="question_60" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_60" type="radio" name="question_60" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_60" type="radio" name="question_60" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_60" type="radio" name="question_60" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_61" type="radio" name="question_61" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_61" type="radio" name="question_61" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_61" type="radio" name="question_61" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_61" type="radio" name="question_61" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_61" type="radio" name="question_61" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_62" type="radio" name="question_62" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_62" type="radio" name="question_62" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_62" type="radio" name="question_62" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_62" type="radio" name="question_62" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_62" type="radio" name="question_62" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_63" type="radio" name="question_63" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_63" type="radio" name="question_63" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_63" type="radio" name="question_63" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_63" type="radio" name="question_63" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_63" type="radio" name="question_63" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_64" type="radio" name="question_64" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_64" type="radio" name="question_64" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_64" type="radio" name="question_64" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_64" type="radio" name="question_64" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_64" type="radio" name="question_64" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_65" type="radio" name="question_65" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_65" type="radio" name="question_65" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_65" type="radio" name="question_65" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_65" type="radio" name="question_65" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_65" type="radio" name="question_65" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_66" type="radio" name="question_66" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_66" type="radio" name="question_66" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_66" type="radio" name="question_66" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_66" type="radio" name="question_66" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_66" type="radio" name="question_66" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_67" type="radio" name="question_67" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_67" type="radio" name="question_67" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_67" type="radio" name="question_67" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_67" type="radio" name="question_67" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_67" type="radio" name="question_67" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_68" type="radio" name="question_68" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_68" type="radio" name="question_68" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_68" type="radio" name="question_68" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_68" type="radio" name="question_68" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_68" type="radio" name="question_68" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_69" type="radio" name="question_69" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_69" type="radio" name="question_69" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_69" type="radio" name="question_69" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_69" type="radio" name="question_69" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_69" type="radio" name="question_69" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_70" type="radio" name="question_70" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_70" type="radio" name="question_70" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_70" type="radio" name="question_70" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_70" type="radio" name="question_70" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_70" type="radio" name="question_70" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_71" type="radio" name="question_71" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_71" type="radio" name="question_71" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_71" type="radio" name="question_71" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_71" type="radio" name="question_71" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_71" type="radio" name="question_71" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input id="question_72" type="radio" name="question_72" value="4">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_72" type="radio" name="question_72" value="3">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_72" type="radio" name="question_72" value="2">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_72" type="radio" name="question_72" value="1">
                                </td>
                                                                                        
                                <td class="text-center">
                                    <input id="question_72" type="radio" name="question_72" value="0">
                                </td>
                            </tr>
